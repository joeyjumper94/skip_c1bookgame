...
class AWSWMod(Mod):
    def mod_info(self):
        return ("Skip Remy's book Sort game", "v0.1", "joeyjumper94")

    def mod_load(self):
        skip_c1booksort_skip_choice=modast.find_label("reset")
        skip_c1booksort_skip_no=skip_c1booksort_skip_choice.next
        connect(skip_c1booksort_skip_choice,modast.find_label("skip_c1booksort_skip_choice"))
        connect(modast.find_label("skip_c1booksort_skip_no"),skip_c1booksort_skip_no)
